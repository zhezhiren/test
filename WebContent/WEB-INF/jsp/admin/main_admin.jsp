  ...
  function DateIsValid(){	
   ...
   Ext.onReady(function(e){
		  ...
		  var northRegion = new Ext.Panel({
		      region:'north',	       
		      html:"<div id='top'><div id='logo'></div><div id='top_t'> <p class='zi'>欢迎您，Admin!&nbsp;<a href='javascript:showWindow();'>【修改密码】</a>&nbsp;<a href='#'>【退出系统】</a></p></div></div>",//"<div style='font-size:15pt;'>吉林气象县级综合业务平台    欢迎当前用户：&nbsp;&nbsp;" +userId +"  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期：&nbsp;&nbsp;"+ time +"</h1>",
			  bbar:[ //{&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},
