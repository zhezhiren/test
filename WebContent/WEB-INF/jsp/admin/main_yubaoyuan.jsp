   ...
   Ext.onReady(function(e){
		...
		//	<font id="noFont"  class="x-form-item" style="font-size:20px" color="red">时间配置说明：</font>'  	
		  ...
		  var northRegion = new Ext.Panel({
		      ...
		      collapsed : true,
		      collapsible : true,
		      html:"<div id='top'><div id='logo'></div><div id='top_t'> <p class='zi'>欢迎您，"+ userName +"!&nbsp;<a href='javascript:showWindow();'>【修改密码】</a>&nbsp;<a href='javascript:ExitSystem();'>【退出系统】</a></p></div></div>",//"<div style='font-size:15pt;'>吉林气象县级综合业务平台    欢迎当前用户：&nbsp;&nbsp;" +userId +"  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日期：&nbsp;&nbsp;"+ time +"</h1>",
			  bbar:[ //{&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;},
